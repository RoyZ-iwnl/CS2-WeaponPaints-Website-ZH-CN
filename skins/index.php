...
if(!isset($_POST['weapon'])) {
    ...
    if($Website_UseCategories) {
        if(!isset($_POST['category']) || !in_array($_POST['category'], $categories)) {
            $_POST['category'] = 'knifes';
        }
    
        $weapon_type_select = ['','','','','','',''];
        $translateSelected = $translations->skins->categories->selected_category;
        switch($_POST['category']) {
            case 'pistols':
                $weapon_type_select[1] = "data-text='$translateSelected' class='selected'";
                break;
            case 'rifles':
                $weapon_type_select[2] = "data-text='$translateSelected' class='selected'";
                break;
            case 'smg':
                $weapon_type_select[3] = "data-text='$translateSelected' class='selected'";
                break;
            case 'mg':
                $weapon_type_select[4] = "data-text='$translateSelected' class='selected'";
                break;
            case 'snipers':
                $weapon_type_select[5] = "data-text='$translateSelected' class='selected'";
                break;
            case 'shotguns':
                $weapon_type_select[6] = "data-text='$translateSelected' class='selected'";
                break;
            default:
                $weapon_type_select[0] = "data-text='$translateSelected' class='selected'";
                break;
        }
    }
?>
            ...
            <ul>
                <?php
                    ...
                    foreach($full_skins as $weapon) {
                        if($Website_UseCategories && GetWeaponType($weapon->weapon_name) != $_POST['category']) {
                            continue;
                        }
                        if($weapon->paint == 0) {
...
<footer>
    <div class="wrapper">
        ...
        <div class="credit">
            <p>[DMR.gg] | 2017-2024 | Web Design From LielXD</p>
        </div>
